...
const subject_resolver_1 = require("./subject.resolver");
...
SubjectModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([subject_entity_1.Subject]), students_module_1.StudentsModule],
        controllers: [],
        providers: [subject_service_1.SubjectService, subject_resolver_1.SubjectResolver],
